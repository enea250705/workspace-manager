...
export default function Schedule() {
  ...
  // Format date range for display basato sull'esistingSchedule se disponibile
  const dateRangeText = existingSchedule && existingSchedule.startDate && existingSchedule.endDate
